...
class BinaryTree
{
    public:
         ...
         */
        // void helperGetPaths(std::vector<std::vector<T>>& paths,const Node * subRoot,std::vector<T> temp) const;

        int sumDistances() const;
        // int sumDistances(const Node* subRoot,int height) const;
    ...
    private:
         ...
         */
         ...
         bool isOrderedHelper(const Node * subRoot,int min,int max) const;
